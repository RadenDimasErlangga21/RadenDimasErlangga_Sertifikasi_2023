...
import 'package:my_cash_book/app/utility/hash_password.dart';

class SettingController extends GetxController {
  RxBool isLoading = false.obs;
  RxBool obsecureText = true.obs; // Untuk mengontrol visibilitas teks kata sandi saat ini
  RxBool obsecureTextNew = true.obs; // Untuk mengontrol visibilitas teks kata sandi baru
  TextEditingController passC = TextEditingController(); // Controller untuk kata sandi saat ini
  TextEditingController passNewC = TextEditingController(); // Controller untuk kata sandi baru
  final DatabaseHelper dbHelper = DatabaseHelper.instance; // Objek DatabaseHelper
