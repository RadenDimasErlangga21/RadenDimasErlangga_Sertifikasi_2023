    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            Image.asset(
              "assets/images/raden.jpg", // Gambar profil atau identitas pembuat aplikasi
              width: mWidth / 3,
            ),
            const Column(
              ...
              children: [
                ...
                SizedBox(height: 11), // Spasi
                Text("Aplikasi ini dibuat oleh:"), // Info pembuat
                Text("Nama\t\t\t  : Raden Dimas Erlangga"), // Nama pembuat
                Text("NIM\t\t\t\t\t\t  : 2141764121"), // NIM pembuat
                Text("Tanggal\t: 26 September 2023"), // Tanggal pembuatan
              ],
            )
          ],
        ),
            ...
            children: [
              ...
              Obx(
                () => CustomInput(
                  ...
                  obsecureText: controller.obsecureText.value, // Kontrol visibilitas teks saat ini
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      controller.obsecureText.value =
                          !(controller.obsecureText.value); // Toggle visibilitas teks saat ini
                    },
                  ),
                ),
              ),
              Obx(
                () => CustomInput(
                  ...
                  obsecureText: controller.obsecureTextNew.value, // Kontrol visibilitas teks kata sandi baru
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      controller.obsecureTextNew.value =
                          !(controller.obsecureTextNew.value); // Toggle visibilitas teks kata sandi baru
                    },
                  ),
                ),
              ),
